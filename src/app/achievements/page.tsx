...
export default function AchievementPage() {
 ...
 >
 Elite <br /> <span className="text-orange-600 bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-amber-500 pr-8 pb-4 inline-block">Milestones.</span>
 </motion.h1>
