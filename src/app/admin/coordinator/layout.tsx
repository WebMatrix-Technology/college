    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-slate-50 font-sans selection:bg-fuchsia-200 selection:text-fuchsia-900">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-slate-900 text-white z-50 sticky top-0 shadow-lg">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-fuchsia-600 rounded-lg flex items-center justify-center shadow-lg shadow-fuchsia-600/30">
            <span className="text-white font-black text-xs">C</span>
          </div>
          <div>
            <h1 className="text-sm font-black uppercase tracking-tighter text-white leading-none">Vanguard</h1>
            <p className="text-[8px] font-black uppercase tracking-widest text-fuchsia-400 mt-0.5">Course Coordinator</p>
          </div>
        </div>
        <button 
