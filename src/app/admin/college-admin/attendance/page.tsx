...
import { CalendarCheck, AlertTriangle, Download, Search, Filter, UserX, CheckCircle } from "lucide-react";
      ...
      <div className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          <h1 className="text-4xl font-black uppercase italic tracking-tighter text-slate-900 flex items-center gap-4">
            ...
            Global <span className="text-emerald-600">Attendance</span>
          </h1>
          <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mt-2">Campus-wide Tracking & Defaulter Logs</p>
        </div>
         ...
         <div className="space-y-6">
            ...
            <div className="bg-red-50 p-6 rounded-3xl border border-red-100 flex items-start gap-4">
               ...
               <div>
                 ...
                 <button className="mt-3 bg-red-600 text-white px-4 py-2 rounded-lg text-[9px] font-black uppercase tracking-widest hover:bg-red-700 transition-colors shadow-lg">
                   Dispatch Warnings
                 </button>
               </div>
            </div>
