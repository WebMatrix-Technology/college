    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-slate-50 relative overflow-hidden">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-slate-900 text-white z-50 sticky top-0 shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-black uppercase tracking-tighter text-white leading-none">VANGUARD CORE</h1>
            <p className="text-[8px] font-black uppercase tracking-widest text-orange-400 mt-0.5">Super Admin</p>
          </div>
        </div>
        <button 
